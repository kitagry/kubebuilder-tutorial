...
import (
	...
	batchv1 "github.com/kitagry/kubebuilder-tutorial/api/v1"
)
...
// +kubebuilder:rbac:groups=batch,resources=cronjobs,verbs=get;list;watch;create;update;put;patch;delete
